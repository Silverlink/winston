...
var Logger = exports.Logger = function (options) {
  ...
  this._parentLogger  = options.hasOwnProperty('parentLogger')
...
Logger.prototype.log = function (level) {
  ...
  async.forEach(Object.keys(this.transports), emit, cb);
...
Logger.prototype.query = function (options, callback) {
  ...
  //
  transports = Object.keys(this.transports).map(function (name) {
...
Logger.prototype._getExceptionHandlers = function () {
  ...
  }).concat(Object.keys(this.transports).map(function (name) {
